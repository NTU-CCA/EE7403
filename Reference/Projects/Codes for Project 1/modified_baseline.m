...
m3 = sum(sum(xout))/n;
xout(find(xout>m3)) = m3;

m4 = sum(sum(xout))/n;
xout(find(xout>m4)) = m4;

m5 = sum(sum(xout))/n;
xout(find(xout>m5)) = m5;

m6 = sum(sum(xout))/n;
xout(find(xout>m6)) = m6;

m7 = sum(sum(xout))/n;
xout(find(xout>m7)) = m7;

m8 = sum(sum(xout))/n;
xout(find(xout>m8)) = m8;

m9 = sum(sum(xout))/n;
xout(find(xout>m9)) = m9;

m10 = sum(sum(xout))/n;
xout(find(xout>m10)) = 0;
